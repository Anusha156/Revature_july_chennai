package com.projects.quickcart.buyer.service;
...
import com.projects.quickcart.buyer.dao.CartDAO;
import com.projects.quickcart.buyer.dao.OrderDAO;
import com.projects.quickcart.buyer.dao.ProductDAO;
import com.projects.quickcart.buyer.dao.WishlistDAO;
import com.projects.quickcart.buyer.dto.CheckoutForm;
...
public class CartServiceImpl implements CartService {
	...
	public boolean isProductInCart(Long id1, long id) {
		return cartDAO.isProductInCart(id1, id);
	}
	...
	public void placeOrder(long customerId, CheckoutForm form) {
		...
		cart.forEach(item -> {
			...
			cartDAO.removeItem(customerId, item.getId());
